...
public class FieldMap {
    ...
    public static final double POWERPORT_TARGET_HEIGHT = Units.inchesToMeters(89.75);
    public static final double POWERPORT_CENTER_HEIGHT = Units.inchesToMeters(98.25);
}
